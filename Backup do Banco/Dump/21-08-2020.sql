...
INSERT INTO `despacho_manutencao` VALUES (5,'TESTE3','2020-01-01','NUNCA',1,1),(7,'TESTE4','2020-01-01','NUNCA',1,1),(8,'TESTE5','2020-01-05','UM DIA',1,1),(10,'DDDD','2020-01-06','UM DIA',3,NULL),(11,'NAO LIGA','2020-01-01','NUNCA',4,NULL);
...
INSERT INTO `equipamento` VALUES (1,'1564','TESTE','ABRIL DE 2019','N',1),(2,'123456','PC DELL','MAIO 2020','S',1),(3,'AAAA','AAAAA','ABRIL DE 2019','S',2),(4,'PMG456','IMPRESSORA TERMICA','ABRIL DE 2019','S',3);
...
CREATE TABLE `ordem_servico` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `NUM_ORDEM_SERVICO` varchar(10) NOT NULL,
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `ORDEM_SERVICO` (`NUM_ORDEM_SERVICO`),
  KEY `ID_EQUIPAMENTO` (`ID_EQUIPAMENTO`),
...
INSERT INTO `ordem_servico` VALUES (1,'556','2020-01-04','2020-04-04',1,'123','ALGUNSSSSS','VARIOS',1500.00),(2,'123','2020-01-02',NULL,4,'12','AAAA','VARIOS',369.00);
...
INSERT INTO `retorno_manutencao` VALUES (1,'testes ok','2020-07-07',1,1),(2,'TESTES OK','2020-01-05',4,NULL);
...
INSERT INTO `tipo_equipamento` VALUES (1,'COMPUTADOR'),(2,'AAAA'),(3,'IMPRESSORA');
...
-- Dump completed on 2020-08-21 17:16:24
